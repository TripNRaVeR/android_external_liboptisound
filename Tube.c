...
void processTube(tubeFilter *tubefilter, float* inputs, float* outputs, unsigned frames) {
	...
	for (i = 0; i < frames; ++i)
	{
		...
		tubefilter->fRec0[0] = (tubeout - (tubefilter->toneStack16 * (((tubefilter->toneStack14 * tubefilter->fRec0[2])
           + (tubefilter->toneStack13 * tubefilter->fRec0[1])) + (tubefilter->toneStack11 * tubefilter->fRec0[3]))));
		...
		outputs[i] = ((tubefilter->toneStack664 * ((tubefilter->toneStack663 * tubefilter->fRec24[0])
            + ((tubefilter->toneStack662 * tubefilter->fRec24[1]) + ((tubefilter->toneStack660 * tubefilter->fRec24[3])
			+ (tubefilter->toneStack658 * tubefilter->fRec24[2]))))) + ((tubefilter->toneStack638 * ((tubefilter->toneStack637 * tubefilter->fRec23[0])
            + ((tubefilter->toneStack636 * tubefilter->fRec23[1])
